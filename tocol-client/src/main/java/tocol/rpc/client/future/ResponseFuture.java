...
public class ResponseFuture {
    ...
    private static final Map<Long, ChannelManager> channelManagerMaps = new
            ConcurrentHashMap<Long, ChannelManager>();

    private static final Map<Long, ResponseFuture> futureMaps = new ConcurrentHashMap<Long,
			ResponseFuture>();
